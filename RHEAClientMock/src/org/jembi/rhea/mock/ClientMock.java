...
public class ClientMock {
	...
	*/
	...
	public ClientMock() throws KeyStoreException, NoSuchAlgorithmException,
			CertificateException, IOException, KeyManagementException {
		// Get the key store that includes self-signed cert as a "trusted"
		// entry.
		InputStream keyStoreStream = ClientMock.class
	...
	public String callQueryFacility() throws IOException,
		...
		// Setup connection
		URL url = new URL(hostname + "ws/rest/v1/facilities");
